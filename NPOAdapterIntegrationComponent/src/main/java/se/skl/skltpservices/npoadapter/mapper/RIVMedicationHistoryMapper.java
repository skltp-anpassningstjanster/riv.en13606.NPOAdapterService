...
public class RIVMedicationHistoryMapper extends MedicationHistoryMapper {
	...
	public MuleMessage mapRequest(final MuleMessage message) throws MapperException {
		try {
			...
			final RIV13606REQUESTEHREXTRACTRequestType ehrRequest = EHRUtil.requestType(req, MEANING_LKM_ORD, message.getUniqueId(), message.getInvocationProperty("route-logical-address"));
