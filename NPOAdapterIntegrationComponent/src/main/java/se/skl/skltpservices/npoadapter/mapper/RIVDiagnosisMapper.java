...
public class RIVDiagnosisMapper extends DiagnosisMapper {
	...
	public MuleMessage mapRequest(final MuleMessage message) throws MapperException {
		try {
			...
			final RIV13606REQUESTEHREXTRACTRequestType ehrRequest = EHRUtil.requestType(req, MEANING_DIA, message.getUniqueId(), message.getInvocationProperty("route-logical-address"));
